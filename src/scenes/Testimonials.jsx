  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        >
          <p className="font-playfair text-4xl">Shelly Donval</p>
          <p className="text-center text-xl mt-8">"Aliquam, amet dui feugiat facilisi dui."</p>
        </motion.div>
        ...
        <motion.div
          ...
          variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 } }}
        >
          <p className="font-playfair text-4xl">Kristen Kerry</p>
          <p className="text-center text-xl mt-8">"Aliquam, amet dui feugiat facilisi dui."</p>
        </motion.div>
        ...
        <motion.div
          ...
          variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 } }}
        >
          <p className="font-playfair text-4xl">Mattis Kruff</p>
          <p className="text-center text-xl mt-8">"Aliquam, amet dui feugiat facilisi dui."</p>
        </motion.div>
      </div>
    </section>
